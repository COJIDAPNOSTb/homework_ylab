...
public class OrderService {
    ...
    */
    public OrderService(CarRepository carRepository,OrderRepository orderRepository, UserService userService) {
    ...
    */
    ...
    if (!existingOrders.isEmpty()) {
        throw new IllegalArgumentException("Order for this car already exists.");
    }
